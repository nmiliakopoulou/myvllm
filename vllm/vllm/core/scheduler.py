...
class Scheduler:
    ...
    def _get_num_new_uncached_and_cached_tokens(
        ...
        rtb = budget.remaining_token_budget()
        with open("/home/nmi4/vllm/benchmarks/memory_kvcache.txt", "a") as f:
            print(f"{num_uncached_new_tokens}, {rtb}",file=f)
