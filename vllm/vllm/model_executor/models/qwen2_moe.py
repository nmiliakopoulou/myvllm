    ...
    def forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
        ...
        if self.tp_size > 1:
            final_hidden_states = tensor_model_parallel_all_reduce(
                final_hidden_states)
        #print(f"time for shared experts {b-a}")
        #with open('/home/nmi4/moe_exp_latency.txt', 'a') as myfile:
        #    print(f"time for experts {d-c}", file=myfile)
        #with open('/home/nmi4/moe_gate_latency.txt', 'a') as myfile:
        #    print(f"router logits {router_logits}", file=myfile)
        #with open('/home/nmi4/moe_shared_latency.txt', 'a') as myfile:
        #    print(f"time for shared experts {b-a}", file=myfile)
...
class Qwen2MoeDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        #    print(f"Attention layer latency {e-d}", file=myfile)
        #with open('/home/nmi4/moe_layernorm_latency.txt', 'a') as myfile:
        #    print(f"Layer norm latency {g-e}", file=myfile)
        #with open('/home/nmi4/moe_total_latency.txt', 'a') as myfile:
        #    print(f"MoE layer latency {f-g}", file=myfile)
...
class Qwen2MoeModel(nn.Module):
    ...
    def forward(
        ...
        my_tensor: Optional[IntermediateTensors] = None,
        ...
        if get_pp_group().is_first_rank:
            ...
            #    print(f"Inference latency {b-a}", file=myfile)
        else:
            assert intermediate_tensors is not None
            hidden_states = intermediate_tensors["hidden_states"]
            residual = intermediate_tensors["residual"]
            b = time.time()
            #with open('/home/nmi4/inpemb2_latency.txt', 'a') as myfile:
            #    print(f"Inference latency {b-a}", file=myfile)
        d = time.time()
        for i in range(self.start_layer, self.end_layer):
            ...
            with open('/home/nmi4/hidd_states.txt', 'a') as myfile:
                print(f"{hidden_states}", file=myfile)
        ...
        #    print(f"Inference latency {e-d}", file=myfile)
        #with open('/home/nmi4/norm_latency.txt', 'a') as myfile:
        #    print(f"Inference latency {f-e}", file=myfile)
        return hidden_states, my_tensor
...
class Qwen2MoeForCausalLM(nn.Module, SupportsPP):
    ...
    def forward(
        ...
        start=time.time()
        hidden_states, my_tensor = self.model(input_ids, positions, kv_caches,
                                   attn_metadata, intermediate_tensors,
                                   inputs_embeds)
        end=time.time()
        with open('/home/nmi4/inference_latency.txt', 'a') as myfile:
            print(f"Inference latency {end-start}", file=myfile)
